...
<head>
    <!-- Title Tag  -->
    <title>Renewal Energy Solutions - Royal Shemesh</title>
...
<body id="bg" style="" class="bg-light">
                                                    ...
                                                    <div class="menu-home-menu-container">
                                                        ...
                                                        <ul id="nav" class="nav main-menu menu navbar-nav">
                                                            ...
                                                            <li class="icon-active"><a href="#">Our Services</a>
                                                                <ul class="sub-menu">
                                                                    <li><a href="technology.php">IT and Technology Solutions</a></li>
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        ...
                        <div class="bread-menu">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><a href="renewable-energy-products.php">Our Products</a></li>
                            </ul>
                        </div>
                        <!-- Bread Title -->
                        <div class="bread-title wow fadeInUp"><h2>Renewable Energy Products</h2></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card wow fadeInUp custom-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 3-4m pole or on the wall </li>
                                <li class="list-group-item">Solar Panel: 6W</li>
                                <li class="list-group-item">LiFePO4 battery: 7.4V 5Ah</li>
                                <li class="list-group-item">Only sample now in stock</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
                    ...
                    <div class="card wow fadeInUp custom-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 4-6m pole Top </li>
                                <li class="list-group-item">Solar Panel: 25W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/15W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 4-6m pole or on wall </li>
                                <li class="list-group-item">Solar Panel: 40W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/20W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 5-7m Pole or on the wall </li>
                                <li class="list-group-item">Solar Panel: 60W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/30W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 6-8m pole Top </li>
                                <li class="list-group-item">Solar Panel: 60W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/40W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 7-9m pole or on wall </li>
                                <li class="list-group-item">Solar Panel: 90W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/60W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 8-10m Pole </li>
                                <li class="list-group-item">Solar Panel: 110W</li>
                                <li class="list-group-item">LED Lamps: 12V/80W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar garden light for 3-5m pole Top </li>
                                <li class="list-group-item">Solar Panel: 80W</li>
                                <li class="list-group-item">LiFePO4 battery</li>
                                <li class="list-group-item">LED Lamps: 12V/20W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                ...
                <div class="col col-md-4 col-sm-6 mb-4">
                    <div class="card custom-shadow wow fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">All in one solar billboard light 24W LED </li>
                                <li class="list-group-item">Solar Panel: 50W</li>
                                <li class="list-group-item">LiFePO4 battery LED Lamps: 12V/24W</li>
                                <li class="list-group-item">3 years limited warranty</li>
                            </ul>
                            <div class="text-center p-3"> <a href="contact.php" class="btn btn-primary" style="background-color: darkblue">Get in touch</a></div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="service-sidebar">
                    <!-- Single Sidebar -->
                    <div class="service-single-sidebar widget wow fadeInUp">
                        <h2 style="font-size: 44px" class=" wow fadeInUp text-center">What We Do</h2>
                        <div class="menu-service-menu-container" style="margin-top:  10px">
                            <!-- Service Menu -->
                            <ul id="menu-service-menu" class="menu wow fadeIn">
                                <li  class="wow fadeInUp widget-title"><a style="font-size: 19px" href="renewal-energy.php">Renewal Energy Solutions</a></li>
                                <li  class="wow fadeInUp widget-title"><a style="font-size: 19px" href="technology.php">IT and Technology Solutions</a></li>
                                <li  class="wow fadeInUp widget-title"><a style="font-size: 19px" href="cyber-security.php">Cyber Security Solutions</a></li>
                                <li  class="wow fadeInUp widget-title"><a style="font-size: 19px" href="events.php">Business Development and Consultancy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-widget footer-about widget">
                            <h3 class="widget-title wow bounceIn">Royal Shemesh</h3>
                            <div class="footer-widget-about-description">
                                <p class="wow fafadeInUp">Established in Accra, Ghana, Royal Shemesh Limited has over 4 years provides services to both Local and international bodies.
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-widget f-link widget">
                            ...
                            <ul>
                                ...
                                <li><a href="cyber-security.php">Cyber Security Solutions</a></li>
                                <li><a href="events.php">Business Development Consultancy</a></li>
                            </ul>
                        </div>
                        <!--/ End Footer Links -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-widget footer_contact widget">
                            ...
                            <ul class="address-widget-list">
                                <li class="footer-mobile-number"><i class="fa fa-phone"></i>+233 (0)243723218</li>
                                <li class="footer-mobile-number"><i class="fa fa-envelope"></i>info@royalshemesh.com</li>
                                <li class="footer-mobile-number"><i class="fa fa-map-marker"></i>P.O.Box OS 321 Osu – Accra</li>
                            </ul>
                        </div>
                        <!--/ End Footer Contact -->
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-content">
                            <!-- Copyright Text -->
                            <p>© Copyright <a href="#">Royal Shemesh.</a> Powered By <a target="_blank" href="https://cyclux.com/">Cyclux Consult</a></p>
                        </div>
                    </div>
                </div>
            </div>
